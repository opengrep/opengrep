 ...
 *
 * SARIF has Test_scan_subcommand_sarif.ml, where the output goes has
 * Test_scan_subcommand_output.ml, and what a scan reports has
 * Test_scan_subcommand_findings.ml.
 *)
