...
# A lambda assigned to a variable, whose body propagates: source flows through cb to sink.
def runner_pos():
...
# A lambda assigned to a variable, whose body does not propagate: source must NOT reach sink.
