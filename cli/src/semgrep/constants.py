...
ID_KEY = "id"
CLI_RULE_ID = "-"
PLEASE_FILE_ISSUE_TEXT = "An error occurred while invoking the Opengrep engine. Please help us fix this by creating an issue at https://github.com/opengrep/opengrep"
...
DEFAULT_ALLOW_RULE_TIMEOUT_CONTROL = False
DEFAULT_DYNAMIC_TIMEOUT = False
DEFAULT_DYNAMIC_TIMEOUT_MAX_MULTIPLIER = 20
DEFAULT_DYNAMIC_TIMEOUT_UNIT_KB = 30
