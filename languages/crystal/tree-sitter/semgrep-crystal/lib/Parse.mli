...
(**
    Functions for parsing crystal programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a crystal program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.expressions, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a crystal program from a file into a typed OCaml CST.
