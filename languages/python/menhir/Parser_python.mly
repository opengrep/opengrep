...
excepthandler:
  ...
  (* python3.14 (PEP 758): `except A, B:` means "catch A or B", same as
   * `except (A, B):`. Always interpreted as a tuple of exception types.
   * This drops python2's `except Type, name:` bind-via-comma form, but
