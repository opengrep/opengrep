...
| 3 | [03-dispatch.md](03-dispatch.md) | **Interfile_dispatch** — how the taint engine consumes the call graph: relevant subgraph, SCC signature fixpoint, the shared signature database, bodiless declarations. |
