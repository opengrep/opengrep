...
- **Value:** `true` or `false`
- **Default:** `unset, the scan's --dynamic-timeout applies`
- **See also:** [`--allow-rule-timeout-control`](../flags/allow-rule-timeout-control.md), [`--dynamic-timeout`](../flags/dynamic-timeout.md), [`--timeout`](../flags/timeout.md), [`timeout`](timeout.md), [`dynamic_timeout_unit_kb`](dynamic_timeout_unit_kb.md), [`dynamic_timeout_max_multiplier`](dynamic_timeout_max_multiplier.md)
<!-- END GENERATED: facts -->
